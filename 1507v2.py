...
def replace_image_with_translated(page: fitz.Page, xref: int, page_num: int, img_index: int, target_lang: str):
    try:
        ...
        page.insert_image(img_rect, stream=img_stream.getvalue())
        page._wrap_contents()  # Ensures content is saved
    ...
    for page_num, page in enumerate(doc):
        ...
        try:
            ...
            for img_index, img in enumerate(image_list):
                ...
                try: 
                    replace_image_with_translated(page, xref, page_num, img_index, target_lang)
                except Exception as e:
